...
public class Param1Controller {
    ...
    public String param6(@RequestParam String name, @RequestParam(defaultValue = "0") String password) {
        System.out.println("name = " + name);
        System.out.println("password = " + password);
        return "param1";
    }
    @RequestMapping("param5")
    public String param5(@RequestParam String name, @RequestParam(defaultValue = "99999") String password) {
        System.out.println("name = " + name);
        System.out.println("password = " + password);
        return "param1";
    }
